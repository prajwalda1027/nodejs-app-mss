...
app.get('/mithuntechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to prajwla Please Contact +91-9980226  +91-9980923216 +91-9014996877 for more information or send an email to devopstrainingblr@gmail.com <center></h2>" );
    response.end();
